...
const Page = () => {
  ...
  return (
    // <div className="min-[1144px]:max-w-6xl w-full min-[1144px]:flex min-[1144px]:mx-auto py-6 min-[1144px]:gap-x-10">
    //   <div className="min-[1144px]:max-w-3xl max-w-2xl mx-auto w-full">
    //     {/* Stories Section */}
    //     <StoryFrag />
